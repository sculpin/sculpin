...
class SculpinContentTypesExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach ($config as $type => $setup) {
            ...
            $singularNames = (new EnglishInflector())->singularize($type);
            $singularName = $setup['singular_name'] ?? end($singularNames);
            ...
            foreach ($setup['taxonomies'] as $taxonomy) {
                ...
                $singularNames = (new EnglishInflector())->singularize($taxonomyName);
                $taxon = end($singularNames);
