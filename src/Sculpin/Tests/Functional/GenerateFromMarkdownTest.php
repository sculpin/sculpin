...
class GenerateFromMarkdownTest extends FunctionalTestCase
{
    ...
    public function shouldGenerateAnHtmlFileFromMarkdown()
    {
        $this->copyFixtureToProject(
            __DIR__ . '/Fixture/source/hello_world.md', '/source/hello_world.md'
        );
    ...
    {
        $this->copyFixtureToProject(
            __DIR__ . '/Fixture/source/hello_world.md', '/source/hello/world.md'
        );
    ...
    {
        $this->addProjectFile(
            '/source/_layouts/my_layout.html.twig', <<<EOT
<body>
...
EOT
        ...
        $this->addProjectFile(
            '/source/my_page_with_layout.md', <<<EOT
---
...
EOT
        ...
        $crawler = $this->crawlGeneratedProjectFile(
            '/my_page_with_layout/index.html'
        );

        $pageContentEl = $crawler->filter('.page-content');
        $this->assertEquals(
            1, $pageContentEl->count(),
