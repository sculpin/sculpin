...
class FunctionalTestCase extends \PHPUnit_Framework_TestCase
{
    ...
    protected function assertProjectHasFile($filePath, $msg = null)
    {
        ...
        $this->assertTrue(
            self::$fs->exists(self::ProjectDir() . $filePath), $msg
        );
    }
    ...
    protected function assertProjectHasGeneratedFile($filePath, $msg = null)
    {
        ...
        $msg = $msg
            ?: "Expected project to have generated file at path $filePath.";
    ...
    private function readFile($filePath)
    {
        if (!self::$fs->exists($filePath)) {
            throw new \PHPUnit_Framework_Exception(
                "Unable to read file at path $filePath: file does not exist"
            );
        }
        ...
        if ($content === false) {
            throw new \PHPUnit_Framework_Exception(
                "Unable to read file at path $filePath: failed to read file."
            );
        }
