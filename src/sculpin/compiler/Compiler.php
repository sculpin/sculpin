...
class Compiler
{
    ...
    public function compile($pharFile = 'sculpin.phar')
    {
        ...
        $this->addFile($phar, new \SplFileInfo($this->projectRoot . '/vendor/autoload.php'));
    ...
    /**
     * Add a file to a phar
     *
     * @param \Phar        $phar  phar
     * @param \SplFileInfo $file  File
     * @param bool         $strip Strip whitespace?
     */
     ...
     * @param \Phar $phar phar
     */
    private function addSculpinBin(\Phar $phar)
    {
